...
-- 2000년도 이전 입사한 입사자들에 대한 정보를 담을 테이블
...
-- 2000년도 이후 입사한 입사자들에 대한 정보를 담을 테이블
...
/*
    ...
    SET 컬럼명 = 바꿀 값,
        컬럼명 = 바꿀 값,
        ...                 --> 여러개의 컬럼값을 동시변경 가능(,로 나열해야됨!! AND 아님)
...
SET JOB_CODE = 'J9'
WHERE EMP_NAME = '노옹철';
-- ORA-02291: integrity constraint (KH.SYS_C007217) violated - parent key not found
-- FOREIGN KEY 제약조건 위배!!
