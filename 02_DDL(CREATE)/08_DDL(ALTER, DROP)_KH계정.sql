/*
    ...
    * 변경할 내용
    1) 컬럼 추가 / 수정 / 삭제
    2) 제약조건 추가 / 삭제 --> 수정은 불가 (수정하고자 한다면 삭제한 후에 새로이 추가)
    3) 컬럼명 / 제약조건명 / 테이블명 수정
*/
...
-- 디폴트 값을 바꾼다고 해서 이전에 추가된 데이터가 바뀌는 것은 아니다!!
...
-- SYS_C007229 => DCOPY_LID_NN
ALTER TABLE DEPT_COPY RENAME CONSTRAINT SYS_C007229 TO DCOPY_LID_NN;
